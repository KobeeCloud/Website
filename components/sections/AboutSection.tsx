...
const stats = [
  { value: 'Azure', label: 'Główna specjalizacja', icon: '☁️' },
...
const competencies = [
  { text: 'Microsoft Azure (główna specjalizacja) + AWS & GCP', preferred: false },
...
export function AboutSection() {
  return (
    <section id="o-firmie" className="py-24 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6 animate-fade-in">
            ...
            <span className="text-sm font-medium text-muted">Poznaj mnie bliżej</span>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-6 group hover:border-primary/50 transition-all duration-500">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">Doświadczenie komercyjne</h3>
              </div>
              <div className="space-y-2 text-muted text-sm">
                <p className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0 animate-pulse-glow" />
                  Automatyzacja infrastruktury w Azure (Terraform, Ansible)
                </p>
                <p className="flex items-start gap-2">
                ...
                <p className="flex items-start gap-2">
                  ...
                  Praca z zespołami nad stabilnością systemów produkcyjnych
                </p>
              </div>
            </div>
            ...
            <div className="glass-card p-6 group hover:border-primary/50 transition-all duration-500">
              ...
              <div className="space-y-2 text-muted text-sm">
                ...
                <p className="flex items-start gap-2">
                  ...
                  Strony WWW (Next.js, React, TypeScript)
                </p>
              </div>
            </div>
            ...
            <div className="glass-card p-6 group hover:border-primary/50 transition-all duration-500">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">Lokalizacja</h3>
              </div>
              <p className="text-muted text-sm">
                Luzino, obsługuję całe <span className="text-foreground font-medium">Trójmiasto</span> i pracuję <span className="text-foreground font-medium">zdalnie</span>.
                    ...
                    <span>
                      ...
                      {comp.preferred && (
                        <span className="text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-full ml-2 animate-pulse-glow">
                          {comp.preferred === true ? 'Preferowane' : comp.preferred}
                        </span>
                      )}
                    </span>
                  </li>
